...
elseif(isset($_GET["edit"]))
{
    ...
    <article class="module width_quarter">
		...
		<div class="module_content">
            <ul>
                <li><a href="<?="commerce-gerer.php?edit=".$_GET["edit"]?>">Retour à la gestion du commerce</a></li>
                <li><a href="<?="commerce-gerer.php?edit=".$_GET["edit"]."&amp;adresse"?>">Ajouter une adresse</a></li>
                <?php
				if($nbproduits<10)
				{
				...
				?>
                <li><a href="<?="commerce-gerer.php?edit=".$_GET["edit"]."&amp;textes"?>">Modifier les textes</a></li>
                <li><a href="<?="commerce-gerer.php?edit=".$_GET["edit"]."&amp;image"?>">Modifier les images</a></li>
                <li><a href="<?="commerce-gerer.php?edit=".$_GET["edit"]."&amp;tel"?>">Modifier les numéros de téléphone</a></li>
                <li><a href="<?="commerce-gerer.php?edit=".$_GET["edit"]."&amp;type"?>">Modifier le type de commerce</a></li>
                <li><a href="<?='../commerce.php?q='.$_GET["edit"].''?>" target="_blank">Aperçu</a></li>
            </ul>
            <?php if($_SESSION["niveau"]==9)
			{
                ...
                <fieldset>
					...
					<input type="text" id="points" name="points" value="<?=$points?>" />
				</fieldset>            
        ...
        <article class="module width_full">
		    ...
		    <div class="tab_container">
                ...
                <fieldset>
					...
					<textarea id="contenu" name="contenu" rows="12" style="height:500px;"><?=$contenu?></textarea>
				</fieldset>            
        ...
        <article class="module width_full">
		    ...
		    <div class="tab_container">
                ...
                <fieldset>
					...
					<input type="text" id="gsm" name="gsm" value="<?=$gsm?>" />
                    <p><br /></p><br /><br />
	...
	elseif(isset($_GET["image"]))
	{
        ...
        <article class="module width_half">
		    ...
		    <div class="module_content">
                ...
                <form id="form" method="post" action="commerce-gerer.php?edit=<?=$_GET["edit"]?>">
		...
		<div class="module_content">
                ...
                <form id="form2" method="post" action="commerce-gerer.php?edit=<?=$_GET["edit"]?>">
	...
	{
		$id=""; $rue=""; $numero=""; $localite=""; $cp=""; $pays=""; $type="";
        ...
        <article class="module width_full">
		    ...
		    <div class="tab_container">
                ...
                <fieldset style="width:73%; float:left; margin-right: 3%;">
					...
					<input type="text" name="rue" id="rue" value="<?=$rue?>" style="width:92%;"/>
				</fieldset>
				<fieldset style="width:23%; float:left;">
					<label for="numero">Numéro</label>
					<input type="text" name="numero" id="numero" value="<?=$numero?>" style="width:92%;"/>
				</fieldset><div class="clear"></div>
            
                <fieldset style="width:73%; float:left;margin-right: 3%;">
					<label for="localite">Localité</label>
					<input type="text" name="localite" id="localite" value="<?=$localite?>" style="width:92%;"/>
				</fieldset>
                <fieldset style="width:23%; float:left; ">
					<label for="cp">Code postal</label>
					<input type="text" name="cp" id="cp" value="<?=$cp?>" style="width:92%;"/>
				</fieldset><div class="clear"></div>
	...
	elseif(isset($_GET["produit"]))
	{
        ...
        <article class="module width_full">
		    ...
		    <div class="module_content">
                ...
                <input type="hidden" id="id" name="id" value="<?=$_GET["produit"]?>"/>
                <fieldset>
					<label for="titre">Nom du produit</label>
					<input type="text" id="titre" name="titre" value="<?=$nom?>" />
				</fieldset>            
                ...
                <footer>
				    <div class="submit_link">
					    <input type="submit" name="gerer_produit" id="gerer_produit" value="<?=$text_button?>" class="alt_btn">
					    <input type="submit" value="Reset">
                        </form>
                    </div>
                </footer>
