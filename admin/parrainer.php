				...
				<div class="module_content">                
        		 	<form name="ajouter" id="ajouter" action="parrainer.php" enctype="multipart/form-data">
                        <fieldset>
                            ...
                            <input type="text" name="nom" id="nom" value="<?=$titre?>" />
                        </fieldset>
                        ...
                        <fieldset style="width:23%; float:left;">
                            ...
                            <input type="text" name="numero" id="numero" value="<?=$num?>" style="width:92%;"/>
                        ...
                        <fieldset style="width:40%; float:left; margin-right: 3%;">
                            ...
                            <input type="text" name="telephone" id="telephone" value="<?=$pays?>" />
                        </fieldset>                        
					</div>
                    <div class="clear"></div>
                        <footer>
   ...
   if(isset($_REQUEST["envoyer"])) 
	{
			...
			while($donnees=$stmt->fetch())
			{
				...
				$destinataire = 'fdortu@fastmail.net';
