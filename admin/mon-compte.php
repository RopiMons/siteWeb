...
if(isset($_POST["moduser"]))
{
	...
	else
	{
		...
		$verif_mail=Verif($_POST["mail"],"adresse E-mail",8,48,"email");
		$verif_pseudo=Verif($_POST["pseudo"],"Pseudo",2,32);
			
		if($verif_nom!=1 && $verif_prenom!=1 && $verif_mail!=1 && $verif_pseudo!=1)
		{
			$message="";
		...
		else
		{
			...
			$msg1='<h4 class="alert_success">Réussite - Votre profile a été modifié.</h4>';
		}
		if($_POST["pass"]!="")
		{
			if($_POST["confirm"]!="")
