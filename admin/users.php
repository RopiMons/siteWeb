	...
	<section id="main" class="column">		
				...
				?>
					<form name="adduser" id="adduser" action="users.php?add" method="post">
                        <fieldset style="width:48%; float:left; margin-right: 3%;">
							...
							<input type="text" name="prenom" id="prenom" value="<?=$prenom?>" style="width:92%;"/>
						</fieldset>
						<fieldset style="width:48%; float:left;">
							<label for="nom">Nom</label>
							<input type="text" name="nom" id="nom" value="<?=$nom?>" style="width:92%;"/>
		...
		<article class="module width_half">
			...
			?>
				...
				$stmt->closeCursor();
				?>
					<form name="adduser" id="adduser" action="users.php?mod=<?=$_GET["mod"]?>" method="post">
                    <input type="hidden" name="idpersonnes" id="idpersonnes" value="<?=$_GET["mod"]?>"/>
                        <fieldset style="width:48%; float:left; margin-right: 3%;">
							<label for="prenom">Prénom</label>
							<input type="text" name="prenom" id="prenom" value="<?=$prenom?>" style="width:92%;"/>
						</fieldset>
						...
						<fieldset>
                            ...
                            <input type="hidden" name="premierpass" id="premierpass" value="<?=$password?>"/>
						</fieldset>
						<fieldset> 
							<label>Type d'utilisateur</label>
                            <?php
