...
if(isset($_POST["adduser"])) 
{
  ...
  <div class="control-group">
       ...
       <div class="controls">
           <input type="text" id="prenom" placeholder="Votre prénom" name="prenom" value="<?=$prenom?>" >
       </div>
  </div>
  <div class="control-group">
       <label class="control-label" for="nom">Nom</label>
       <div class="controls">
           <input type="text" id="nom" placeholder="Votre nom" name="nom" value="<?=$nom?>" >
       </div>
  </div>
  <div class="control-group">
       <label class="control-label" for="pseudo">Pseudo</label>
  ...
  <div class="control-group">
       ...
       <div class="controls">
           <input type="text" id="mail" placeholder="Votre adresse E-mail" name="mail" >
       </div>
  </div>
  <div class="control-group">
